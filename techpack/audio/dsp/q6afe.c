...
//#define CONFIG_SND_SOC_AWINIC_AW87XXX
#ifdef CONFIG_SND_SOC_AWINIC_AW87XXX
...
// #define AFE_PORT_ID_AWDSP_RX			(AFE_PORT_ID_QUATERNARY_MI2S_RX)
#define AFE_PORT_ID_AWDSP_RX			(AFE_PORT_ID_SLIMBUS_MULTI_CHAN_6_RX)
#endif /* #ifdef CONFIG_SND_SOC_AWINIC_AW87XXX */
