#ifndef __AW87XXX_MONITOR1_H__
#define __AW87XXX_MONITOR1_H__

/**********************************************************
 * aw87xxx monitor
***********************************************************/
static const char aw87xxx_vmax_cfg_name1[] = { "aw87xxx_pid_xx_vmax_" };
...
enum aw87519_dsp_msg_type1 {
	DSP_MSG_TYPE_DATA = 0,
	DSP_MSG_TYPE_CMD = 1,
};

enum aef_module_type1 {
	AW_RX_MODULE = 0,
	AW_TX_MODULE = 1,
};
...
static const uint32_t PARAM_ID_INDEX_TABLE1[][INDEX_PARAMS_ID_MAX] = {
	{
