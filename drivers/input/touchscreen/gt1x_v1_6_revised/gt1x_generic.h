...
#define GT_I2C_NAME "gt-ts"
#if GT_DEBUG
#define GT_LOG(fmt, args...)    pr_err("[%s] %s %d: " fmt, GT_I2C_NAME, __func__, __LINE__, ##args)
#else
#define GT_LOG(fmt, args...)    pr_info("[%s] %s %d: " fmt, GT_I2C_NAME, __func__, __LINE__, ##args)
#endif
#define GT_ERR(fmt, args...)    pr_err("[%s] %s %d: " fmt, GT_I2C_NAME, __func__, __LINE__, ##args)
...
struct goodix_pinctrl {
	...
	struct pinctrl_state *pinctrl_normal;
	struct pinctrl_state *pinctrl_poweroff;
